...
CREATE TABLE `treatment_medication_sheet_data` (
  ...
  `administration_record_1` text DEFAULT NULL,
  `administration_record_2` text DEFAULT NULL,
  `administration_record_3` text DEFAULT NULL,
  `administration_record_4` text DEFAULT NULL,
  `administration_record_5` text DEFAULT NULL,
  `single_val` longtext DEFAULT NULL,
...
-- Dump completed on 2024-08-13 19:27:55
