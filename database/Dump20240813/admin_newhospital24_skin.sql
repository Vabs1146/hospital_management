...
CREATE TABLE `skin` (
  ...
  `PalmSole` text DEFAULT NULL,
  `GenitalArea` text DEFAULT NULL,
  `OralMucosa` text DEFAULT NULL,
  `Nails` text DEFAULT NULL,
  `SpecialComment` text DEFAULT NULL,
  `FollowUpDoctor_id` int(11) NOT NULL,
  `FollowUpDate` text DEFAULT NULL,
  `FollowUpTime` text DEFAULT NULL,
  `BeforeImagePath` text DEFAULT NULL,
  `AfterImagePath` text DEFAULT NULL,
  `casePaperImage` text DEFAULT NULL,
