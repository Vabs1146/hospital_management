...
CREATE TABLE `eye_examination_vision` (
  ...
  `dd_ref_type` text DEFAULT NULL,
  `dd_undialated` text DEFAULT NULL,
  `dd_normal` text DEFAULT NULL,
  `dd_withglass_1` text DEFAULT NULL,
  `ipd` text DEFAULT NULL,
  `dd_glass_for_cost_use` text DEFAULT NULL,
  `dd_glass_single_pair` text DEFAULT NULL,
  `dd_white_glass_2` text DEFAULT NULL,
  `dd_glass_other` text DEFAULT NULL,
