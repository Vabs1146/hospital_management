...
CREATE TABLE `dentists` (
  ...
  `advised_treatment_1` text DEFAULT NULL,
  `advised_treatment_2` text DEFAULT NULL,
  `advised_treatment_3` text DEFAULT NULL,
  `advised_treatment_4` text DEFAULT NULL,
  `advised_treatment_5` text DEFAULT NULL,
  `is_diabetes` text DEFAULT NULL,
  `is_bp` text DEFAULT NULL,
  `is_haemophiles` text DEFAULT NULL,
  `any_other_disease` text DEFAULT NULL,
