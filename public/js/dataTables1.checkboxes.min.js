...
(function (factory) {
                ...
                if (ctx.aoColumns[i].checkboxes) {
                    ...
                    if (ctx.aoColumns[i].mRender === null) {
                        colOptions["render"] = function () {
                            return '<input type="checkbox" id="selectrec" name="selectrec[]" class=" chk filled-in dt-checkboxes " /><label for="selectrec"></label>';
                        };
                    }
    ...
    Checkboxes.defaults = {
        ...
        selectAllRender: '<input type="checkbox" id="all"  class="filled-in " /><label for="all"></label>',
    };
