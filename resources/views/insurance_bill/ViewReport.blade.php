    ...
    $(document).ready(function() {
		...
		"lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
    		...
    		"drawCallback": function ( settings ) {
    			...
    			//----------------------------------------------------------------------
    			var api = this.api();
    			$( api.table().footer() ).html("<th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th><span style='b'>Sub Total "+
    				api.column( 8, {page:'current'} ).data().sum()+"</span></th><th><span style='b'>Discount "+
    				api.column( 9, {page:'current'} ).data().sum()+"</span></th><th><span style='b'>Total "+
    				api.column( 10, {page:'current'} ).data().sum()+"</span></th></th><th><th><span style='b'>Balance "+
    				api.column( 12, {page:'current'} ).data().sum()+"</span></th>"
    			);
    		}
    	} );
    });
