...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  @include('shared.error')
                          ...
                          @endif
                  <div class="card">
                        <div class="header" style="float:none;margin:auto;">
...
var case_amount_total = 0;
	 theGrid = $('#thegrid').DataTable({
		...
		"ajax": "{{url('ipdbill/payment-report/grid')}}/",
        "columnDefs": [
			{
				"targets": 0,
				"visible": true,
        ...
        "drawCallback": function ( settings ) {
			...
			$( api.table().footer() ).html("<th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th><span style='b'>Sub Total "+
				api.column( 8, {page:'current'} ).data().sum()+"</span></th><th><span style='b'>Balance "+
				api.column( 9, {page:'current'} ).data().sum()+"</span></th>"
			);
        }
    } );
