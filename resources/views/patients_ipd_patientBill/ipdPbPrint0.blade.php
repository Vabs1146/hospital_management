...
<body>
 <div class="container-fluid">    
    ...
    <div class="row">
        ...
        <div class="row">
	<div class="col-sm-12">
		<center><h4><strong><u>IPD Summary Bill</u></strong></h4></center>
		</div>
	</div>
   <br>
	 ...
	 <div class="row">
	  ...
	  <div class="row">
        <div class="col-sm-6">
            <label class="control-label">UHID no. :</label> {{ $patientRegister->uhid_number }}
        </div>
        <div class="col-sm-6">
            <label class="control-label">IPD No. :</label>   {{ $patientRegister->ipd_number }}
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <label for="name" class="control-label">Patient Name :</label>   {{ $patientRegister->first_name .' '. $patientRegister->middle_name .' '. $patientRegister->last_name}} 
        </div>
        <div class="col-sm-6">
    ...
    <!--<div class="row">
        <div class="col-sm-6">
            <label class="control-label">Gaurdian Name :</label>   {{ $patientRegister->responsible_realtive_name  }}  
        </div>
        <div class="col-sm-3">
            <label class="control-label">Ward Type :</label>   {{ $all_wards[$patientRegister->ward_type] }}
        </div>
        <div class="col-sm-3">
            <label class="control-label">Bed No. :</label>   {{ $all_beds[$patientRegister->bed_number] }}
        </div>
    </div>-->
    <!--<div class="row">
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-6">
            <label class="control-label">Admission Date & Time :</label>   {{ $patientRegister->admission_date_time  }}  
        </div>
        <div class="col-sm-6">
            <label class="control-label">Discharge Date & Time :</label>   {{ $discharge_data->discharge_date_time }}
        </div>
    </div>
                     @php
                        ...
                        @if(!empty($billItems) && count($billItems) > 0 )
                            ...
                            @foreach($billItems as $bdata)
                                <tr>
                                    ...
                                    <td> {{ $ipd_particulars_all[$bdata->particular] }} </td>
                                    <td> {{ $bdata->day }} </td>
                                    <td> {{ $bdata->rate }} </td>
