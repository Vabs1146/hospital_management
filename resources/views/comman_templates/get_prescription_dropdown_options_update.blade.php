	...
	<!-- <div class="col-md-3 initial_options">
		<div class="input-group">
			<div class="form-line">
				...
				<input class="form-control" type="text" placeholder="value1" class="initial_optionsval" name="initial_optionsval[]" value="{{$form_dropdowns_array_row['ddText']}}">
			</div>
			<span class="input-group-addon remove-initial-options" type="button"><i class="fa fa-times" aria-hidden="true"></i></span>
		</div>
	</div> -->

	<div class="col-md-12 initial_options">
		<div class="input-group">
			<div class="col-md-1">
				{{$medicine_index++}}.
			</div>
			<div class="col-md-4">
				<div class="form-line">
					<input class="form-control" type="hidden" placeholder="value1" class="initial_optionsid" name="initial_optionsid[]" value="{{$key}}">
					<input class="form-control" type="text" placeholder="Medicine" class="initial_optionsval" name="initial_optionsval[]" value="{{$form_dropdowns_array_row['ddText']}}">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-line">
					<input class="form-control" type="text" placeholder="Generic Name" class="initial_optionsval" name="generic_name[]" value="{{$form_dropdowns_array_row['generic_name']}}">
				</div>
			</div>
			<div class="col-md-1">
				<span class="input-group-addon remove-initial-options" type="button"><i class="fa fa-times" aria-hidden="true"></i></span>
