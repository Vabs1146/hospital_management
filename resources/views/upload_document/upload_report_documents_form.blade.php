...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    @include('shared.error')
                       ...
                       {{ Form::model($casedata, array('route' => array('ipd-store-upload-report-documents'), 'method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data' )) }}
            ...
            {{ csrf_field() }}
                        ...
                        <div class="body">
                          ...
                          <div class="col-md-12">
<div class="col-md-12">
  <div class="col-md-2"><label>Uploads : </label></div>
  <div class="col-md-5"><input type="text" class="" id="upload_report_title" name="upload_report_title"></div>
  <div class="col-md-5"><input type="file" class="" id="upload_report" name="upload_report"></div>
...
<div class="form-group">
  <a target="_blank" href="{{ asset('/sp_test_images/'.$value['filePath']) }}">{{$value['filePath']}}</a><br>

<input type="text" class="input-image-title" name="old_images_title[{{$value['id']}}]" value="{{$value['title']}}"><br>
