...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			<form action="{{ url('nurses-over-report/'.$registration_data->id) }}" method="POST" class="form-horizontal" id="gynform">
				<div class="header bg-pink">
					<h2>Nurses Over Report</h2>
				</div>
				...
				<div class="body">
					...
					@if(count($final_data) > 0) 
						@foreach($final_data as $final_data_key => $row_data)
							@php $identifier = $row_data->date; @endphp
							@include('nurses_over_report.elements.nurses_over_report_main_row')
						@endforeach
