...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">eye Operation Add/Edit</h2>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
    ...
    <script type="text/javascript">
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/eyeoperation/') }}/'+row[0]+'/edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Add/Edit</a>';
                        },
                        "sortable": false,
                        "targets": 6                    
                    }
                    ...
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/eyeoperation/print') }}/'+ row[0] + '" target="_blank"><i class="fa fa-print" aria-hidden="true"></i>print</a>';
                        },
                        "sortable": false,
                        "targets": 7                    
                    }
        ...
        function doDelete(id) {
            if(confirm('You really want to delete this record?')) {
               $.ajax({ url: '{{ url('/eyeoperation') }}/' + id, type: 'DELETE'}).success(function() {
                theGrid.ajax.reload();
               });
            }
            return false;
