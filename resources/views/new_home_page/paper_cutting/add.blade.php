...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  @include('shared.error') 
                    ...
                    @endif
                    <div class="card">
                  <form action="{{ url('/manage-paper-cutting'.( isset($model['id']) ? "/" . $model['id'] : "")) }}" method="POST" class="form-horizontal" enctype = 'multipart/form-data'>
                     {{ csrf_field() }}
                     
                         <div class="header bg-pink">
                            <h2>
                                Add/Modify Paper Cutting
                            </h2>
                        ...
                        <div class="body">
                          ...
                          {{ Form::checkbox('is_active', 1, $model['is_active'],array('id'=>'remember_me_3')) }}
                            ...
                            <div class="col-md-12">                           
                              ...
                              <a class="btn btn-default btn-lg" href="{{ url('/section-paper-cutting') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                              </div>
                              </div>
                            ...
                            <!-- End Of row -->
                             ...
                             <input type="hidden" name="type" id="type" value="section_paper_cutting">
                          </form>
                        </div>
