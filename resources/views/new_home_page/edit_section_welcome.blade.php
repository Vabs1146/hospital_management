...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  @include('shared.error') 
                    ...
                    @endif
                    <div class="card">
                  <form action="{{ url('/manage-section-welcome'.( isset($model['id']) ? "/" . $model['id'] : "")) }}" method="POST" class="form-horizontal" enctype = 'multipart/form-data'>
                     {{ csrf_field() }}
                     
                         <div class="header bg-pink">
                            <h2>
                                Add/Modify Welcome Section
                            </h2>
                        ...
                        <div class="body">
                          ...
                          {{ Form::checkbox('is_active', 1, $model['is_active'],array('id'=>'remember_me_3')) }}
                            ...
                            <!-- End Of row -->
                             ...
                             <input type="hidden" name="type" id="type" value="section_welcome">
                          </form>
                        </div>
