...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  @include('shared.error') 
                    ...
                    @endif
                    <div class="card">
                  <form action="{{ url('/manage-section-slider-footer2'.( isset($model['id']) ? "/" . $model['id'] : "")) }}" method="POST" class="form-horizontal" enctype = 'multipart/form-data'>
                     {{ csrf_field() }}
                     

                         <div class="header bg-pink">
                            <h2>
                                Add/Modify Slider Footer 2
                            </h2>
...
<div class="col-md-6 ">
<div class="form-group">
<img class="img-responsive thumbnail" src="{{ Storage::disk('local')->url($model['img_url']) }}" alt="Image" width="304" height="300">
...
@endif
                            ...
                            <div class="col-md-12">                           
                             <div class="col-md-2">
                              ...
                              <div class="form-group">
                              <div class="form-line">
                              <input required type="text" name="title" id="title" class="form-control" value="{{$model['title'] or ''}}">
                              </div>
                              </div>
                              </div>
                              ...
                              <div class="form-group">
                              <div class="form-line">
                              <input required type="text" name="description" id="description" class="form-control" value="{{$model['description'] or ''}}">
                              </div>
                              </div>
                              </div>
                            </div>
                          ...
                          {{ Form::checkbox('is_active', 1, $model['is_active'],array('id'=>'remember_me_3')) }}
                            ...
                            <div class="col-md-12">                           
                              ...
                              <a class="btn btn-default btn-lg" href="{{ url('/section-slider-footer') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                              </div>
                              </div>
                            ...
                            <!-- End Of row -->
                             ...
                             <input type="hidden" name="type" id="type" value="section_slider_footer2">
                          </form>
                        </div>
