...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  @include('shared.error') 
                    ...
                    @endif
                    <div class="card">
                  <form action="{{ url('/manage-event'.( isset($model['id']) ? "/" . $model['id'] : "")) }}" method="POST" class="form-horizontal" enctype = 'multipart/form-data'>
                     {{ csrf_field() }}
                        ...
                        <div class="body">
                            ...
                            <div class="col-md-12 ">
                              ...
                              <div class="form-line">
                              <input type="file" name="uploadeImage[]" id="uploadeImage" class="form-control" multiple> 
                               </div>                             
                              </div>
                              </div>
							   ...
							   @if(isset($model['img_url']) && !empty($model['img_url']))
								 ...
								 @php
									$images = explode(',', $model['img_url']);
								 @endphp

									<div class="col-md-12">
										@foreach($images as $images_row)
										<div class="col-md-3 image-div">
											<input type="hidden" name="old_images[]" value="{{$images_row}}">
											<div class="form-group">
												<img class="img-responsive thumbnail" src="{{ Storage::disk('local')->url($images_row) }}" alt="Image" width="304" height="300">
                            ...
                            <div class="col-md-12">                           
                             <div class="col-md-2">
							  ...
							  <textarea name="description" id="description" class="form-control">{{$model['description'] or ''}}</textarea>
                              </div>
                              </div>
                              </div>
                            </div>
							...
							<div class="col-md-12">
                              ...
                              <div class="col-md-2">
								  <div class="form-group labelgrp">
									  <label for="description" class="form-control">Start Date :</label>
								  </div>
                              </div>
                              ...
                              <div class="col-md-4">
								  <div class="form-group">
									  <div class="form-line">
										  <input type="text" name="start_date" id="start_date" class="form-control datepicker" value="{{$model['start_date'] or ''}}">
									  </div>
								  </div>
                              </div>
                                ...
                                <div class="col-md-2">
								  <div class="form-group labelgrp">
									  <label for="description" class="form-control">End Date :</label>
								  </div>
                              </div>
                              ...
                              <div class="col-md-4">
								  <div class="form-group">
									  <div class="form-line">
										  <input type="text" name="end_date" id="end_date" class="form-control datepicker" value="{{$model['end_date'] or ''}}">
									  </div>
								  </div>
                              </div>  
                            </div> 
                            ...
                            <div class="col-md-12">                           
                              ...
                              <a class="btn btn-default btn-lg" href="{{ url('/section-our-departments') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                              </div>
                              </div>
