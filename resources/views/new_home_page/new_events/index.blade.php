    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            theGrid = $('#thegrid').DataTable({
                ...
                "ordering": true,
                "responsive": false,
                "ajax": { 'url':'{{url('events-grid')}}', 'type':'POST', data: {_method: 'POST', _token :$("#hdnCsrfToken").data('token')}},
                "columnDefs": [
                    {
                    ...
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/list-comments') }}/'+row[0]+'" class="btn btn-default">View Comments</a>';
                        },
                        "targets": 4                    },
                    {
                        "render": function ( data, type, row ) {
