                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/AddEdit/prescription/') }}/'+row[0]+'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>';
                        },
                        "sortable": false,
                        "targets": 6                    
                    },
                    {
                        "render": function ( data, type, row ) {
                            ...
                            return '<a href="{{ url('/print/prescription') }}/' + row[0] + '"><i class="fa fa-print" aria-hidden="true"></i>Print</a>';
                        },
                        "sortable": false,
                        "targets": 6+1
                    },
