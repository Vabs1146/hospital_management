                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12">
                                  <a href="{{url('/AddPatient_Details/0')}}" class="btn btn-primary btn-lg" role="button">Add Patinet Details</a>
                                  <a href="{{url('/patientDetails/patient/report')}}" class="btn btn-primary btn-lg" role="button">Patinet report</a>
                                </div>
                        ...
                        <div class="body">
                          <div class="row clearfix">
                           <div class="table-responsive">
                            <table class="table" id="thegrid" data-stripe-classes="[]">
                              <thead>
                                <tr>
...
<input type="hidden" id="hdnCsrfToken" data-token="{{ csrf_token() }}"/>                           </div>  
                        </div>
                    </div>
                </div>
            </div>
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/case_masters') }}/'+row[0]+'">'+data+'</a>';
                        },
                        "targets": 1
                    },
                    {
