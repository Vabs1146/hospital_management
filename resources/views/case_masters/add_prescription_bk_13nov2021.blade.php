				...
				<div class="row clearfix">
					<div class="col-md-12 ">
						...
						<div class="col-md-8">
							<div class="form-group">
								<div class="form-line">
									{{ Form::text('patient_name', null, array('class'=> 'form-control','readonly'=>'readonly')) }}                            
								</div>
							</div>
						</div> 
					</div>   
...
<button id="addFrequency" class="btn btn-default addFrequency" data-templateDiv="FrequencyTemplate">Add</button>
						</div>
