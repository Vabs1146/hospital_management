...
<span id="append_template_row">
	<span class="template-row-added">
		...
		<div class="row clearfix">
			...
			<div class="col-md-3">{{ Form::select('medicine_id[1]', array(''=>'Please select') + $casedata['medicinlist']->pluck('medicine_name','id')->toArray(), null, array('class' => 'form-control select2','data-live-search'=>'true')) }}</div>
			
			<div class="col-md-2">Generic Medicine</div>
			<div class="col-md-3">{{ Form::select('generic_medicine_id[1]', array(''=>'Please select') + $casedata['medicinlist']->where('is_generic', '1')->pluck('medicine_name','id')->toArray(), null, array('class' => 'form-control select2','data-live-search'=>'true')) }}</div>
			<div class="col-md-2"></div>
		</div>
		...
		<div class="row clearfix">
			...
			<div class="col-md-3">{{ Form::select('duration[1]', array(''=>'Please select') + $casedata['quantity']->toArray(), null, array('class' => 'form-control select2','data-live-search'=>'true')) }}</div>
			<div class="col-md-2">Timing</div>
			<div class="col-md-3">{{ Form::select('medicine_timing[1]', array(''=>'Please select') + $casedata['medicine_timing']->toArray(), null, array('class' => 'form-control select2','data-live-search'=>'true')) }}</div>
		...
		<div class="col-md-12 dropdown-container">
			...
			<div class="col-md-1">
				<button class="btn btn-default addFrequency" data-templateDiv="FrequencyTemplate" data-key="1">Add</button>
			</div>
		</div>
	</div>
...
<div style="display:none;" id="row_template">
	<span class="template-row-added">
		...
		<div class="row clearfix">
			<div class="col-md-2">Medicine</div>
			<div class="col-md-3">{{ Form::select('main_medicine_id', array(''=>'Please select') + $casedata['medicinlist']->pluck('medicine_name','id')->toArray(), null, array('class' => 'form-control Dyselect2','data-live-search'=>'true')) }}</div>
			
			<div class="col-md-2">Generic Medicine</div>
			<div class="col-md-3">{{ Form::select('main_generic_medicine_id', array(''=>'Please select') + $casedata['medicinlist']->where('is_generic', '1')->pluck('medicine_name','id')->toArray(), null, array('class' => 'form-control Dyselect2','data-live-search'=>'true')) }}</div>
			<div class="col-md-2"></div>
		</div>
		...
		<div class="row clearfix">
			...
			<div class="col-md-2">Duration</div>
			<div class="col-md-3">{{ Form::select('main_duration', array(''=>'Please select') + $casedata['quantity']->toArray(), null, array('class' => 'form-control Dyselect2','data-live-search'=>'true')) }}</div>
			<div class="col-md-2">Timing</div>
			<div class="col-md-3">{{ Form::select('main_medicine_timing', array(''=>'Please select') + $casedata['medicine_timing']->toArray(), null, array('class' => 'form-control Dyselect2','data-live-search'=>'true')) }}</div>
		...
		<!-- =========================================== -->
			...
			<div class="col-md-12 dropdown-container">
				...
				<div class="col-md-1">
					<button id="addFrequency" class="btn btn-default addFrequency" data-templateDiv="FrequencyTemplate" data-key="">Add</button>
				</div>
			</div>
		</div>
