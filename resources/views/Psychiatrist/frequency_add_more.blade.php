<div style="display:none">
    <div id="FrequencyTemplate">
		...
		<div class="col-md-12 dropdown-container">
			...
			<div class="col-md-3">
			<!-- <div > Frequency <button style="float:right;" class="removeFrequencyRow btn btn-warning" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing..">-</button></div> -->
