...
<input type="hidden" name="old_menses_dosage_id[]" value="{{$ivf_menses_dosage_data_row['dosage_id']}}">
	<span style="width:100px;display: inline-block;">
		<div class="form-line">
			{{ Form::text($hidden.'medicine['.$parent_tr_id_key.'][]', $ivf_menses_dosage_data_row['medicine'], array('class' => 'form-control')) }}                            
		</div>
	</span>
	<span style="width:100px;display: inline-block;">
		<div class="form-line">
			{{ Form::text($hidden.'duration['.$parent_tr_id_key.'][]', $ivf_menses_dosage_data_row['duration'], array('class' => 'form-control')) }}                            
		</div>
	</span>
	<span style="width:100px;display: inline-block;">
		<div class="form-line">
			{{ Form::text($hidden.'time['.$parent_tr_id_key.'][]', $ivf_menses_dosage_data_row['time'], array('class' => 'form-control')) }}                            
		</div>
	</span>
...
<div class="doses-medicine-row">
	<span style="width:100px;display: inline-block;">
		<div class="form-line">
			{{ Form::text($hidden.'medicine['.$parent_tr_id_key.'][]', $ivf_od_menses_doses->medicine, array('class' => 'form-control')) }}                            
		</div>
	</span>
	<span style="width:100px;display: inline-block;">
		<div class="form-line">
			{{ Form::text($hidden.'duration['.$parent_tr_id_key.'][]', $ivf_od_menses_doses->medicine, array('class' => 'form-control')) }}                            
		</div>
	</span>
	<span style="width:100px;display: inline-block;">
		<div class="form-line">
			{{ Form::text($hidden.'time['.$parent_tr_id_key.'][]', $ivf_od_menses_doses->medicine, array('class' => 'form-control')) }}                            
		</div>
	</span>
	<span style="display:none;" class="btn btn-warning od-menses-doses-remove" >-</span>
	<span style="display:none;" class="btn btn-success od-menses-doses-add-more" data-tr_id="{{$parent_tr_id_key}}" >+</span>
