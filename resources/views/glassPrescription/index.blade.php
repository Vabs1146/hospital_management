                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       <button id="search" onclick="return searchPatient()" class="btn btn-default"> Search </button></div>
                                  </div>
                              </div>
                           </div>
                        </div>
    ...
    <script type="text/javascript">
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/glassPrescription/') }}/'+row[0]+'/edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Add/Edit</a>';
                        },
                        "sortable": false,
                        "targets": 6                    
                    }
                    ...
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/glassPrescription/print') }}/'+ row[0] + '"><i class="fa fa-print" aria-hidden="true"></i>print</a>';
                        },
                        "sortable": false,
                        "targets": 7                    
                    }
        ...
        function doDelete(id) {
            if(confirm('You really want to delete this record?')) {
               $.ajax({ url: '{{ url('/glassPrescription') }}/' + id, type: 'DELETE'}).success(function() {
                theGrid.ajax.reload();
               });
            }
            return false;
