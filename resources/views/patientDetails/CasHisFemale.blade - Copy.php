...
<!---------------------------------------------------------------------------->
                          ...
                          <!------Menarche---->
                                        ...
                                        <div class="col-md-4">
                                            <button type="button" name="add" id='menarchbtn' class="btn btn-success ">Set Option </button> 
                          ...
                          <!-------------------end--Investigation Advice----------------->
							...
							<div class="col-md-12">
                             ...
                             <div class="row clearfix">
                                ...
                                <div class="form-group">
                                <a class="btn btn-primary btn-lg" href="{{ url('/AddEdit/prescriptionother/').'/'. $casedata['id'] }}" ><i class="glyphicon glyphicon-chevron-left"></i> Add Prescription </a>
