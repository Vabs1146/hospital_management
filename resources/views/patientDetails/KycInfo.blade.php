...
<div class="col-md-12" style="background: white;">
		...
		<div class="col-md-2" style="height: auto;text-align: center;">
			<img id="patient_pic_view" name="patient_pic_view" alt="The screen capture will appear in this box." src="" onerror="this.onerror=null;this.src='{{url('/')}}/images/user.jpeg';" style="width: 100%;">
		...
		<div class="col-md-10">
			<div class="col-md-12">
				<div class="col-md-3">
					<div class="form-group labelgrp">
						<label class="form-control">Patient New/Old:</label>
					</div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<div class="elective_emergency">
							<input type="radio" id="old_new_1" name="old_new" value="new" checked>New
						</div>
					</div>
				</div>
				...
				<div class="col-md-2">
					<div class="form-group">
						<div class="elective_emergency">
							<input type="radio" id="old_new_2" name="old_new" value="old" >Old
						</div>
					</div>
				</div>
			...
			<div class="col-md-12" id="old_new_related" style="display:none;">
				<div class="col-md-3">
					<div class="form-group labelgrp">
				...
				<div class="col-md-3">
					<div class="form-group">
						<div class="form-line">
							{{ Form::text('case_number', Request::old('case_number'), array('class' => 'form-control', 'placeholder'=>'case number','id'=>'case_number')) }}                                
						</div>
					</div>
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<div class="form-group">
						<div class="form-line">
							{{ Form::text('uhid_no', Request::old('uhid_no'), array('class' => 'form-control', 'id'=>'uhid_no')) }}                             
						</div>
					</div>
				</div>
			</div>
			...
			<!-- <div class="col-md-12">
					...
					<div class="col-md-3">
						<div class="form-group labelgrp">
						<label class="form-control">Patient Type  -->
							<!-- <b class="star">*</b> -->
							 <!-- :</label>
						</div>
					</div>
...
<div class="col-md-12" style="background: white;">
	...
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				{{ Form::text('patient_name', $appDetails->name, array('class' => 'form-control autocompleteTxt', 'placeholder'=>'First Name ','id'=>'patient_name')) }}                          
			</div>
		</div>
	</div>
	...
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				{{ Form::text('patient_middle_name', $appDetails->patient_middle_name, array('class' => 'form-control autocompleteTxt', 'placeholder'=>'Middle Name','id'=>'patient_middle_name')) }}                          
			</div>
		</div>
	</div>
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				{{ Form::text('patient_last_name', $appDetails->patient_last_name, array('class' => 'form-control autocompleteTxt', 'placeholder'=>'Surname','id'=>'patient_last_name')) }}                          
			</div>
		</div>
	</div>
</div>
...
<div class="col-md-12" style="background: white;">
	...
	<div class="col-md-2">
		<div class="form-group">
			<div class="demo-radio-button" style="padding-top: 6px">
				...
				<input type="radio" name="male_female" id="male_female2" value="Baby" required />
				<label for="male_female2">Baby</label>
				<input type="radio" name="male_female" id="male_female3" value="Master" required />
				<label for="male_female3">Master</label>
	...
	<div class="col-md-1">
		<div class="form-group">
			<div class="form-line">
				{{ Form::text('patient_age', Request::old('patient_age'), array('id'=>'patient_age','class' => 'form-control', 'readonly')) }}                            
			</div>
		</div>
	</div>
	<div class="col-md-1">
	...
	<div class="col-md-1">
		<div class="form-group">
			<div class="form-line">
				{{ Form::text('admission_month', Request::old('admission_month'), array('id'=>'admission_month','class' => 'form-control', 'readonly')) }}                            
			</div>
		</div>
	</div>
...
<div id="other_details" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne_1">
	...
	<div class="col-md-12">
							...
							<div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{ Form::text('accompanied_by', Request::old('accompanied_by'), array('class' => 'form-control')) }}                                    
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
							...
							<div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{ Form::text('daily_travel_time', Request::old('daily_travel_time'), array('class' => 'form-control')) }}                                    
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{ Form::text('screen_time', Request::old('screen_time'), array('class' => 'form-control')) }}                                    
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<button id="whatsapp_clicked"  formtarget="_blank" type="submit" formaction="{{ url('/patientDetails/SaveKYCWhatsapp') }}" name="submit" class="btn" value="submit" ><i class="fab fa-whatsapp-square fa-2x" style="color:green;"></i> </button>&nbsp;
<!-- 
<button type="submit" formaction="{{ url('/patientDetails/SaveEyeExamination2') }}" name="submit" class="btn btn-success btn-lg" value="submit" >Submit & Email</button>&nbsp; -->
...
<!-- <button type="submit" name="submit" class="btn btn-success btn-lg" value="submit_ipd" ><i class="fa fa-plus"></i> Submit IPD Patient
                            ...
                            <div class="col-md-8 col-md-offset-2" >
							@if($commonHelper->checkUserAccess("1_appointmentlist/0", Auth::user()->id, 'add_permission') == 1 || $commonHelper->checkUserAccess("1_appointmentlist/0", Auth::user()->id, 'listing_permission') == 1 || AUTH::user()->role == 1)
...
@if($commonHelper->checkUserAccess("2_case_masters", Auth::user()->id, 'listing_permission') == 1 ||AUTH::user()->role == 1)
...
<script type="text/javascript">
	...
	$('input[name="old_new"]').click(function() {
		//alert($(this).val());

		if($(this).val() == "old") {
			$('#old_new_related').show();

		} else {
			$('#old_new_related').hide();
...
<script>
    ...
    jq(".autocompleteTxt").autocomplete({
        ...
        select: function(event, ui) {
            ...
            $('input[name="patient_middle_name"]').val(ui.item.middle_name);
            $('input[name="patient_last_name"]').val(ui.item.last_name);

			$('input[name="patient_area"]').val(ui.item.area);
            $('input[name="city"]').val(ui.item.city);
            $('input[name="district"]').val(ui.item.district);
			
			if(ui.item.mr_mrs_ms != "") {
				let mr_mrs_ms = ui.item.mr_mrs_ms;
				//alert(mr_mrs_ms);
				$('input[value="'+mr_mrs_ms+'"]').click();
			}

			if(ui.item.patient_priority != "") {
				let patient_priority = ui.item.patient_priority;
				//alert(patient_priority);
				$('input[value="'+patient_priority+'"]').click();
			}
 ...
 var data=$("#patient_form").serialize();
	...
	$('.addmore').click(function(e) {
		...
		$('#whatsapp_clicked').click(function() {
			window.location.replace("{{url('AddPatient_Details/0')}}");
		});
		*/
