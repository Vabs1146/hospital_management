...
<div class="container-fluid">
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                @if(empty($doctor->id))
                {{ Form::model($fees_detail, array('url' => 'admin/fees-details')) }}
                @else
                {{ Form::model($fees_detail, array('route' => array('fees-details.update',  $fees_detail->id), 'method' => 'PATCH' )) }}
                @endif
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 doctor-fees">
                            ...
                            <div class="doctor-procedure">
                                ...
                                <div class="col-md-12 each_procedure">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <?php 
                                            $selected = ($doctors_row->procedure_id == $procedure->id)?"selected='selected'":"";
                                         ?>
