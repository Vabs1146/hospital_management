                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   <div class="card-body">
                               <div class="user-list">
                                   ...
                                   <a href="{{ route('add-consultant')}}" class="btn btn-info btn-lg float-right">Add Consultant</a>
                               </div>
                           </div>
                           <br>
                    <div class="card">
                        ...
                        <div class="body">
                              <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="zero_config" name="sectiontable">
                                        ...
                                        <tbody>
                                            @foreach($consultant_list as $galleryname)
                                          <tr>
                                          <td><a href="{{ route('showsubimage',$galleryname->main_id)}}">{{ $galleryname->gallery_name}}</a></td>
                                              ...
                                              <td>{{ $galleryname->degree}}</td>
                                              <td>
                                                  <a href="{{ route('delete-consultant',$galleryname->main_id)}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                              </td>
                                          </tr>
                                          @endforeach
