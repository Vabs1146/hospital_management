...
<div class="row clearfix">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        @include('shared.error')
         ...
         <form class="form-horizontal" method="post" action="{{ route('save-certificates')}}" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="body">
                  <div class="row clearfix ">
                      <div class="col-md-12">
                         ...
                         <!-- <div class="col-md-2">
                          <div class="form-group labelgrp">
                          <label class="form-control">Certificate<br><span class="text-success"></span> :</label>
                          </div>
                          </div>
                          ...
                          <div class="col-md-4">
                           ...
                           <input type="file" class="custom-file-input" id="filenames" name="filenames[]"  required multiple>
                            <label class="custom-file-label" for="filenames">Choose Certicate...</label>                          
                            </div>
                            </div>
                          </div> -->
                      </div>
