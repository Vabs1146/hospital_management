...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  @include('shared.error') 
                    ...
                    @endif
                    <div class="card">
                  <form action="{{ url('/homepage/update-data/') }}" method="POST" class="form-horizontal" enctype = 'multipart/form-data'>

				  <input type="hidden" name="data_type" value="top_slider_text">
                     {{ csrf_field() }}
                      @if (isset($model['id']))
...
<div class="col-md-8">
	<div class="form-group">
		<div class="form-line">
			<textarea type="text" class="form-control" id="data_value" name="data_value" placeholder="value" required>{{ isset($top_slider_text->value) ? $top_slider_text->value : '' }}</textarea>
		</div>
	</div>
</div>
