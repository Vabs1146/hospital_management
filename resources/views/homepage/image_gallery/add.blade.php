...
<input type="text" name="displayed_in" id="displayed_in" class="form-control" value="galleryPage" readonly> 
	...
	<option value="galleryPage">Gallery Page</option>
                          ...
                          {{ Form::checkbox('isActive', 1, $model['isActive'],array('id'=>'remember_me_3')) }}
                            ...
                            <div class="col-md-12">                           
                              ...
                              <a class="btn btn-default btn-lg" href="{{ url('/new-iamge-gallery-list') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                              </div>
                              </div>
                            ...
                            <!-- End Of row -->
                             ...
                             <input type="hidden" name="imgTypeId" id="imgTypeId" value="2">
                          </form>
                        </div>
