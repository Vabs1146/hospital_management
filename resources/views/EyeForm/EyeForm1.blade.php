                              ...
                              <div class="tab-content" id="main_form">
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
{{ Form::select('ChiefComplaint_OD[]', array('Select'=>'-Select-') + $form_dropdowns->where('fieldName', 'Chief Complaint')->pluck('ddText','ddText')->toArray(), array_key_exists('Chief Complaint OD', $defaultValues)?$defaultValues['Chief Complaint OD']:null, array('class'=> 'form-control select2','data-live-search'=>'true')) }}
                                        </div>
                                    ...
                                    <div class="col-md-12 col-md-offset-2" style="margin-bottom: 0px !important;">
                                        <div class="table-responsive col-md-9">
                                            ...
                                            <tfoot>
                                            <tr>
                                            <td colspan="" align="center" style="border: none!important;">&nbsp;</td>
                                            <td style="border: none!important;">
                                            <input type="submit" name="save" id="save" class="btn btn-primary btn-lg" value="Save Option" />
                                            </td>
                                            </tr>
                                            </tfoot>
                                            </table>
...
$(document).ready(function(){
 ...
 function dynamic_field(number)
 {
    alert(number);
  html = '<tr>';
        html += '<td><input type="text" name="optionsval[]" class="form-control" placeholder="add value" id="optionsval'+number+'" /></td>';
