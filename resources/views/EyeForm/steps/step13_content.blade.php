...
<div class="col-md-12">
		...
		<div class="col-md-4">
			...
			<div class="form-line">
			<input type="text" name="patient_name" id="patient_name" class="form-control" value="{{ $case_master_data['patient_name'] or ''}}">
			</div>  
			</div>
		</div>
		...
		<div class="col-md-1">
			<div class="form-group">
			<div class="form-line">
			<input type="text" name="patient_age" id="patient_age" class="form-control"  value="{{ $case_master_data['patient_age'] or ''}}">
			</div>
			</div>
		</div>
		...
		<div class="col-md-2">
			...
			<input name="male_female" type="radio" id="radio_8" class=" with-gap radio-col-pink" value="Male" required  {{ ($case_master_data->male_female == "Male")? "checked=\"checked\"" : "" }}   />
			<label for="radio_8">Male</label>
			<input name="male_female" type="radio" id="radio_10" class="with-gap radio-col-deep-purple" value="Female" required   {{ ($case_master_data->male_female == "Female")? "checked=\"checked\"" : "" }} />
	...
	<div class="col-md-12">
		...
		<div class="col-md-2">
			<div class="form-group">
				<div class="form-line">
				<input readonly type="text" name="uhid_no" id="uhid_no" class="form-control" value="{{ $case_master_data->uhid_no or ''}}">
				</div>  
			</div>
		</div>
		...
		<div class="col-md-2">
			<div class="form-group labelgrp">
			<label for="patient_mobile" class="form-control">Mobile No. :</label>
			</div>
		</div>
		...
		<div class="col-md-2">
			<div class="form-group">
				<div class="form-line">
				<input type="text" name="patient_mobile" id="patient_mobile" class="form-control" value="{{ $case_master_data->patient_mobile or ''}}"> 
				</div>
			</div>
		</div> 
...
<div class="col-md-12">
	<div class="col-md-12 col-md-offset-4">
		<div class="form-group">
			...
			<a type="submit" href="{{ url('/PrintFixSurgery') }}/{{$casedata['id']}}"  class="btn btn-primary btn-lg" target="_blank">Print</a>
		</div>
	</div>
</div> 
