...
">
{{--
                                Patient Name : {{ $commonHelper->get_patient_full_name($casedata['id']) .' 123 '. $casedata['patient_name'] }} | Age : {{ $casedata['patient_age'] }} | Gender : {{ $casedata['male_female'] }} | Case Number : {{ $casedata['case_number'] }} | {{ 'Time :' . $casedata['visit_time']}}  --}}

								 Patient Name : {{ $commonHelper->get_patient_full_name($casedata['id'])}} | Age : {{ $casedata['patient_age'] }} | Gender : {{ $casedata['male_female'] }} | Case Number : {{ $casedata['case_number'] }} | {{ 'Time :' . $casedata['visit_time']}}  
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="wizard-inner">
                               ...
                               <!--  <li role="presentation" class="">
								...
								<li role="presentation" class="">
                                    <a href="#step11" data-toggle="tab" aria-controls="step11" role="tab"><span class="round-tab">10</span> <i>Laser Procedure</i></a>
                                </li>

								<li role="presentation" class="">
                                    <a href="#step12" data-toggle="tab" aria-controls="step12" role="tab"><span class="round-tab">11</span> <i>Images Draw</i></a>
                                </li>
								
								<li role="presentation" class="">
                                    <a href="#step13" data-toggle="tab" aria-controls="step13" role="tab"><span class="round-tab">12</span> <i>Fix Surgery</i></a>
                                </li>
...
<div class="tab-pane js-sweetalert" role="tabpanel" id="step5">
	@include('EyeForm.steps.step5_content')
								...
								<div class="tab-pane js-sweetalert" role="tabpanel" id="step11">
									@include('EyeForm.steps.step11_content')
								</div>

								<div class="tab-pane js-sweetalert" role="tabpanel" id="step12">
									@include('EyeForm.steps.step12_content')
								</div>
								
								<div class="tab-pane js-sweetalert" role="tabpanel" id="step13">
@include('EyeForm.steps.step13_content')
</div>
