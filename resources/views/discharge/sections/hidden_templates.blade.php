<div style="display:none">
	<div id="followup_date_timetemplate">
        <div class="col-md-12">
                <div class="col-md-2">
                   <!--  <input type="hidden" id="followup_date_time[]" name="followup_date_time[]" class="hiddenCounter" value="" /> -->
                </div>
                <div class="col-md-3">
	...
	<div id="investigationTemplate">
        <div class="col-md-12">
                ...
                <div class="col-md-3">
                     {{ Form::select('investigation_OD[]', array(' '=>'-Select-') + $form_dropdowns->where('fieldName', 'investigation')->pluck('ddText','ddText')->toArray(), null, array('class'=> 'form-control Dyselect2')) }}
                </div>
                <div class="col-md-3">
	...
	<div id="discharge_iol_name_template">
        <div class="col-md-12">
                <div class="col-md-2">
                    <input type="hidden" id="discharge_iol_name[]" name="discharge_iol_name[]" class="hiddenCounter" value="" />
                </div>
                <div class="col-md-3">
                  {{Form::select('discharge_iol_name_od[]', array(' '=>'-Select-') + $form_dropdowns->where('fieldName', 'discharge_iol_name_od')->pluck('ddText','ddText')->toArray(), null, array('class'=> 'form-control Dyselect2')) }}
                </div>
                <div class="col-md-3">
                  {{-- Form::select('surgeryvision_os[]', array(' '=>'-Select-') + $form_dropdowns->where('fieldName', 'surgeryvision')->pluck('ddText','ddText')->toArray(), null, array('class'=> 'form-control Dyselect2')) --}}
                </div>
