    ...
    <div id="surgery_history" class="ContainerToAppend">
      <div class="col-md-12">
        <div class="col-md-9">
          ...
          <div class="col-md-5">
            <button type="button" name="add" id='surgerysetbtn' class="btn btn-success set-dropdown-options" data-field_name="surgery_history" data-form_name="EyeForm">Set Option </button>
				...
				<div class="col-md-10">
					<div class="form-group">
						<div class="elective_emergency">
							...
							@php
								if((isset($case_master->elective_emergency) && $case_master->elective_emergency == "Elective") || (isset($case_master->elective_emergency) && $case_master->elective_emergency == "Emergency")) {
									$checked = "";
								} else {
									$checked = "checked";
								}
							@endphp
							<input type="radio" name="elective_emergency" value="Elective" {{(isset($case_master->elective_emergency) && $case_master->elective_emergency == "Elective") ? 'checked' : ''}} {{$checked}}>Elective
							<input type="radio" name="elective_emergency" value="Emergency" {{(isset($case_master->elective_emergency) && $case_master->elective_emergency == "Emergency") ? 'checked' : ''}}>Emergency
						</div>
					</div>
				</div>
			</div> 
