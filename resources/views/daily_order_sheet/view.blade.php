...
<div class="col-md-12">
	...
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				 1. {{ $ivf_icsi->ivf_followup_1 }}  {{$ivf_icsi->ivf_followup_time_1 }}                          
			</div>
		</div>
	</div>
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				 2. {{ $ivf_icsi->ivf_followup_2 }}  {{$ivf_icsi->ivf_followup_time_2 }}                                    
			</div>
		</div>
	</div>
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				 3. {{ $ivf_icsi->ivf_followup_3 }}  {{$ivf_icsi->ivf_followup_time_3 }}                                   
			</div>
		</div>
	</div>
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				 4. {{ $ivf_icsi->ivf_followup_4 }}  {{$ivf_icsi->ivf_followup_time_4 }}                                    
			</div>
		</div>
	</div>
</div>
