...
<div class="col-sm-12">
	...
	<div class="col-sm-2">
		<div class="form-group labelgrp">            
			{{ Form::label('pre_ivf_hysteroscopy','Date :') }} 
		</div>
	</div>
	<div class="col-sm-4">
		<div class="form-group">
			<div class="form-line">           
				{{isset($daily_order_sheet_record->date)? $daily_order_sheet_record->date : '-'}}       
			</div>
		</div>
	</div>
</div>
...
@include('daily_order_sheet.elements.daly_order_sheet_table_print')
