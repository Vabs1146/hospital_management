                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/dynamicForm/5/') }}/'+row[0]+'/edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Add/Edit</a>';
                        },
                        "sortable": false,
                        "targets": 7                    
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/dynamicForm/print/5/') }}/'+row[0] +'"target="_blank" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Print</a>';
                        },
                        "sortable": false,
                        "targets": 8                   
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/dynamicForm/view/5/') }}/'+row[0] +'" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>View</a>';
                        },
                        "sortable": false,
                        "targets": 9                
                    }
