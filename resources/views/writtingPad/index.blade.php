...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Writting Pad</h2>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/writingCasePaper/') }}/'+row[0]+'/edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Add/Edit</a>';
                        },
                        "sortable": false,
                        "targets": 6                    
                    }
                    ...
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/writingCasePaper/print') }}/'+ row[0] + '"><i class="fa fa-print" aria-hidden="true"></i>print</a>';
                        },
                        "sortable": false,
                        "targets": 7                    
                    }
                    ...
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/writingCasePaper/view') }}/'+ row[0] + '"><i class="fa fa-print" aria-hidden="true"></i>View</a>';
                        },
                        "sortable": false,
                        "targets": 8
                    }
