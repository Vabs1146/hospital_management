...
<body>
 <div class="container-fluid">
    <div class="row">
	 ...
	 <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-12 panel panel-default"> <center> <strong> <h3>Discharge Card </h3> </strong> </center> </div>
        </div>
...
<div class="row">
	...
	@endphp
        <label class="control-label">Date :</label> {{ isset($discharge_summary['date_time']) ? date('d/m/Y', strtotime($date_arr[0])) . ' ' . $date_arr[1] : '' }}
    </div>
</div>
...
<div class="row">
        <div class="col-sm-6">
            <label class="control-label">Date of Admission :</label> {{ $admission_date_time }}  
        </div>
        <div class="col-sm-6">
            <label class="control-label">Discharge Date & Time :</label> {{ $discharge_date_time }}
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <label class="control-label">Discharge Against Medical Advice :</label> {!! nl2br($discharge_against_medical_advice) !!} 
    </div>
</div>
...
@php
    ...
    <div class="row">
        <div class="col-sm-12">
            <label class="control-label">History of Present Illness :</label> {!! nl2br($history_of_present_illness) !!}
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <label class="control-label">Medical :</label> {!! nl2br($medical) !!}
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
             ...
             <div class="col-sm-3"><label class="control-label">3. </label> {{$followup_3}}</div>
             <div class="col-sm-3"><label class="control-label">4. </label> {{$followup_4}}</div>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <label class="control-label">Please come to the hospital or contact your doctor immediately if :</label> {!! nl2br($treatment_advice) !!} 
    </div>
</div>

<div class="row">
    <div class="col-sm-12">
        <label class="control-label">In case of following (as applicable) please consult your doctor immediately :</label> {!! nl2br($consult_symptoms) !!} 
    </div>
</div>

<div class="row">
    <div class="col-sm-12">
        <label class="control-label">Notes :</label> {!! nl2br($final_notes) !!} 
    </div>
</div>
