...
<div class="col-md-12">
						...
						<div class="col-md-2">
							...
							<div class="form-group">
							<div class="form-line">
								<input class="form-control datetimepicker" id="date_time" name="date_time" value="{{isset($discharge_summary['date_time']->value_1) ? $discharge_summary['date_time']->value_1 : ''}}" type="text">
							</div>
							</div>
						</div>
					</div>
