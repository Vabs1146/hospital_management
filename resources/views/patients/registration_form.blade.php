				...
				<div class="row clearfix ">
					<div class="col-md-12">
						...
						<div class="col-md-2">
							...
							<div class="form-line">
								<input class="form-control datetimepicker" id="date_time" name="date_time" value="{{date('d/m/Y - h:i A')}}" type="text">
							</div>
							</div>
						</div>
...
<div class="col-md-12" style="background: white;">
	...
	<div class="col-md-2">
		<div class="form-group">
		<div class="form-line">
		<select name="admission_month" id="admission_month" class="form-control">
...
<div class="col-md-12" style="background: white;">
	...
	<div class="col-md-4">
		...
		<select name="admission_type" id="admission_type" class="form-control">
			...
			<option value="Surgery">Ortho</option>
			<option value="Surgery">ICU</option>
		</select>
		</div>
		</div>
	</div>
