    ...
    <body class="theme-red">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter your Name" required value="{{$appointment->name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="mobile_no" id="mobile_no" class="form-control" value="{{$appointment->mobile_no}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <select name="doctor_id" id="doctor_id" class="form-control select2" placeholder="select your doctor" data-live-search="true">
                                                        <?php foreach($doctorlist11 as $doclist) { ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        {{ Form::text('appointment_dt', Request::old('appointment_dt', $appointment->appointment_dt), array('class'=> 'form-control datepicker','id'=>'appointment_dt')) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            $("#appointment_dt").on('change.dp', function (e) {
                ...
                $('#startdate').data('date')
                //alert(appointment_dt);
                var url1 = '{{url("avaibaletimeslots") }}/'+doctor_id+"/"+appointment_dt;
               // alert(url1);
