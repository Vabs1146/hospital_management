    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            theGrid = $('#thegrid').DataTable({
                ...
                "responsive": false,
                "autoWidth": false,
                "ajax": { "url" : "{{url('discharge2/grid')}}", 'type':'POST', data: {_method: 'POST', _token :$("#hdnCsrfToken").data('token')}},
                "order": [[ 0, "desc" ]],
                lengthMenu: [
            [ 10, 25, 50, -1 ],
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/discharge2/') }}/'+row[0]+'/1/edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>';
                        },
                        "sortable": false,
                        "targets": 8                    
                    },
