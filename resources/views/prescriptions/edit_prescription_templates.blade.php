...
<div style="display:none;" id="row_template">
	<span class="template-row-added">
		...
		<div class="row clearfix">
			...
			<div class="col-md-3"><div>Generic Medicine</div>{{ Form::select('main_generic_medicine_id', array(''=>'Please select') + $casedata['medicinlist']->where('is_generic', '1')->pluck('medicine_name','id')->toArray(), null, array('class' => 'form-control Dyselect2','data-live-search'=>'true')) }}</div>
