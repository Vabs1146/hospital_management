...
@endif     
<div class="card">
{{ Form::model($casedata, array('url' => url('update-custom-template').'/'.$case_id, 'method' => 'POST','id'=>'eyeform',  'class' => 'form-horizontal', 'enctype' => 'multipart/form-data' )) }}
{{ csrf_field() }}
...
@include('cataract.procedure_templates.get_procedure_template')
	...
	<div class="row clearfix" style="text-align: right;"> 
		<div class="col-md-8 col-md-offset-2">
			<div class="form-group">
				...
				<a class="btn btn-danger" href="{{url('cataract/'.$case_id)}}/1/edit">Cancel</a>
				@else
				<a class="btn btn-danger" href="{{url('cataract')}}">Cancel</a>
				@endif
			</div>
		</div>
	</div>
