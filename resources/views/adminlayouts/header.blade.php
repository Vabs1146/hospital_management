...
@if($parent_menu[0]->status == 1)                    
                  ...
                  <li class="nav-item has-treeview">
                        ...
                        <ul class="ml-menu nav-treeview">
                           ...
                           @if($permissions['1_appointmentlist/0']->listing_permission || AUTH::user()->role == 1)
                            ...
                            <li class="nav-item">
                                <a href="{{ route('appointmentslot') }}"> Appointments Add Time Slot</a>
                            </li>
                            @endif
 ...
 @if($permissions['15_settings']->listing_permission 
                   ...
                   || AUTH::user()->role == 1)
                    <li>
                       <a href="javascript:void(0);" class="menu-toggle">
                           <i class="fa fa-cog fa-fw myicons"></i> <span class="icon-name">OPD Masters</span> 
                        </a>
                        <ul class="ml-menu">
                            ...
                            @endif
                            <!-- @if($permissions['15_prescription-templates-listing']->listing_permission 
                   || $permissions['15_list-finding-templates']->listing_permission || AUTH::user()->role == 1) -->
							<!-- ======================================================== -->
							<!-- <li class="nav-item has-treeview">
								<a href="javascript:void(0);" class="menu-toggle">
									<i class="fa fa-file fa-fw myicons"></i>
								...
								<ul class="ml-menu nav-treeview">
                                @if($permissions['15_prescription-templates-listing']->listing_permission || AUTH::user()->role == 1)									
									<li class="nav-item">
										<a href="{{url('/prescription-templates-listing/')}}">Presctiption</a>
									</li>
                            @endif
                            
                            @if($permissions['15_list-finding-templates']->listing_permission || AUTH::user()->role == 1)									
									<li class="nav-item">
...
<li class="nav-item has-treeview">
	<a href="javascript:void(0);" class="menu-toggle">
		<i class="fas fa-file-medical-alt myicons" aria-hidden="true"></i><span class="icon-name">OPD Bill Reports</span>
	</a>
	<ul class="ml-menu nav-treeview">
...
<li class="nav-item has-treeview">
	<a href="javascript:void(0);" class="menu-toggle">
        ...
        <i class="fas fa-file-medical-alt myicons" aria-hidden="true"></i><span class="icon-name">IPD Reports</span>
	</a>
	<ul class="ml-menu nav-treeview">
...
--}} 
{{--
@if($permissions['17_home_page_settings']->listing_permission || AUTH::user()->role == 1)   
<li class="nav-item has-treeview">
	<a href="javascript:void(0);" class="menu-toggle">
...
@if($permissions['16_new_website']->listing_permission || AUTH::user()->role == 1)   
                      <li class="nav-item has-treeview">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="fa fa-paper-plane myicons" aria-hidden="true"></i> <span class="icon-name"> Website Settings</span>
                        </a>
                        <ul class="ml-menu nav-treeview">
							<li class="nav-item">
