                ...
                <ul class="list" data-widget="treeview" role="menu" data-accordion="false">
                   ...
                   <li class="active">
                    ...
                    <li class=" nav-item has-treeview menu-open">
                        <a href="{{ route('case_masters.index') }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/case_masters/prescriptionlst') }}">
					...
					@can('isCase_masters_prescriptionlst')
                    <li class="nav-item">
                        <a href="{{ url('/case_masters/prescriptionlstother') }}">
                             <i class="fab fa-renren myicons"></i>
                  ...
                  <li class="nav-item has-treeview">
                        ...
                        <ul class="ml-menu nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{url('/ipdbill_index/')}}">IPD Bill</a>
                            </li>
                            @endcan
                   ...
                   <li class="nav-item has-treeview">
                        ...
                        <ul class="ml-menu nav-treeview">
                            ...
                            <a href="{{ url('dynamicForm/1') }}">IPD Admission</a>
                            </li>
                            @endcan

                            @can('isHomepage_LogoAddEdit')
                            <li class="nav-item">
                            <a href="{{ url('/IPD/patientRegsiter') }}">Patient Register</a>
                            </li>
                            @endcan

                            @can('isHomepage_LogoAddEdit')
                            <li class="nav-item">
                                <a href="{{ url('/IPD/patientBill') }}">Patient's Bill</a>
                            </li>
                            @endcan
                            
                            @can('isHomepage_LogoAddEdit')
                            <li class="nav-item">
                                <a href="{{ url('/IPD/patientMedicine') }}">Medicine Charges</a>
                            </li>
                            @endcan
                      ...
                      <li class="nav-item has-treeview">
                        ...
                        <ul class="ml-menu nav-treeview">
                            ...
                            @can('isHomepage_LogoAddEdit')
                            <li class="nav-item">
                                <a href="{{ route('image_galleries.index') }}"> Slider</a>
                            </li>
                            @endcan
                            ...
                            <li class="nav-item">
                             ...
                             @can('isImagegallary') 
                            <li class="nav-item">
                                <a href="{{ route('gallery_list') }}"> Image Gallery</a>
                            </li>
                             @endcan
                    ...
                    <li>
                       <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            ...
                            @can('isUseraccess')
                            <li>
                                <a href="{{ url('useraccess/0') }}">User Access </a>
                            </li>
                            @endcan
