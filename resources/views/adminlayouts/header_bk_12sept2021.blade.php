                   ...
                   <li class="active">
					...
					<li>
                        <a href="{{url('/covid-consent-form/')}}">
                            <i class="fa fa-home myicons" aria-hidden="true"></i> <span class="icon-name">Covid 19</span>
                        </a>
                    </li>
					
					<li>
                        <a href="{{url('patient-activity')}}" target="_blank">
                            <i class="fa fa-home myicons" aria-hidden="true"></i> <span class="icon-name">Patient View</span>
                        </a>
                    </li>
                        ...
                        <ul class="ml-menu nav-treeview">
                           <!--     @if($permissions['3_ipd_details']->listing_permission || AUTH::user()->role == 1)
                            <li class="nav-item"> 
							  ...
							  @if($permissions['1_AddPatient_Details/0']->listing_permission || AUTH::user()->role == 1)
                            <li class="nav-item"> 
                                <a href="{{url('/add-ipd-patient/0')}}"> Add IPD Patient Details
                               </a>
                            </li>
                              @endif
							...
							<li class="nav-item">
                                <a href="{{url('ipdbill/payment-report')}}">IPD Bill Payment Report</a>
                            </li>
...
<li class="nav-item has-treeview">
	<a href="javascript:void(0);" class="menu-toggle">
		<i class="fa fa-paper-plane myicons" aria-hidden="true"></i> <span class="icon-name">Report</span>
	</a>
	<ul class="ml-menu nav-treeview">
		<li class="nav-item">
			<a href="{{ url('opdbill-report') }}"> OPD Report</a>
		</li>
		<li class="nav-item">
			<a href="{{ url('today-opdbill-report') }}"> Today OPD Report</a>
		</li>
		<li class="nav-item">
			<a href="{{ url('ipdbill-report') }}"> IPD Report</a>
		</li>
		<li class="nav-item">
			<a href="{{ url('ipd-surgery-report') }}"> IPD Surgery Report</a>
		</li>
	</ul>
</li>
