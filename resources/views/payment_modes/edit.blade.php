...
<div class="container-fluid">
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                {{ Form::model($payment_mode, array('route' => array('payment-modes.update',  $payment_mode->id), 'method' => 'PATCH' )) }}
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-4 col-md-offset-4">
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg btn-primary waves-effect"><span>Update Payment Mode</span>
                                </button>
