...
<div class="row">
	...
	<div class="col-sm-4"> {{$ward_bed_payment_data['ipd_bed_number']}} </div>
</div>

<div class="row">
	<div class="col-sm-2"> <label for="date" class="control-label">Provisional Diagnosis/Major Complaint :</label> </div>
	<div class="col-sm-10"> {{$registration_data->provisional_diagnosis}} </div>
</div>
...
<div class="row" style="text-align: center;">
	...
	<div class="col-sm-6"> <label for="date" class="control-label">PATIENT/PATIENT RELATIVES SIGNATURE</label> </div>
</div>
</br></br>
...
<div class="row" style="text-align: center;">
	...
	<div class="col-sm-6"> <label for="date" class="control-label">SIGNATURE OF WITNESS</label> </div>
</div>
