...
<div class="row">
	<div class="col-sm-2"> <label for="date" class="control-label">Towards :</label> </div>
	<div class="col-sm-10"> Advance </div>
</div>

<div class="row">
	<div class="col-sm-2"> <label for="date" class="control-label">Rupees in Word :</label> </div>
	<div class="col-sm-10"> {{$payment_data->advance_amount}} </div>
</div>

<div class="row">
	<div class="col-sm-2"> <label for="date" class="control-label">Rs :</label> </div>
	<div class="col-sm-10"> {{$payment_data->advance_amount}} </div>
</div>
