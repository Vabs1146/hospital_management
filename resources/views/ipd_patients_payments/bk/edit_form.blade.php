		...
		<div class="form-group">
			...
			<select name="ward_type" class="form-control">
				...
				@foreach($ipd_ward_types as $ipd_ward_type)
					<option value="{{$ipd_ward_type->id}}" {{($registration_data->ward_type == $ipd_ward_type->id) ? 'selected' : ''}}>{{$ipd_ward_type->name}}</option>
				@endforeach
			</select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<select name="bed_number" class="form-control">
				...
				@foreach($ipd_bed_numbers as $ipd_bed_number)
					<option value="{{$ipd_bed_number->id}}" {{($registration_data->bed_number == $ipd_bed_number->id) ? 'selected' : ''}}>{{$ipd_bed_number->name}}</option>
				@endforeach
			</select>
			</div>
		</div>
