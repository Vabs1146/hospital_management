...
<body>
 <div class="container-fluid"> 
    ...
    <div class="row">
        ...
        <div class="col-lg-12 panel panel-default"> <center> <h4><strong> Payment Receipt </strong></h4> </center> </div>
    </div>
	@endif
...
<div class="row">
	...
	<div class="col-sm-6">
		...
		{{$convert_to_words->format_date_time($payment->date_time)}}
	</div>
</div>	
<div class="row">	
	<div class="col-sm-6">
...
@php
$totalAmount = 0;
foreach($payment_records as $eachRecords){
    $totalAmount += $eachRecords->advance_amount;
}
if($payment_id == 0){
    $itemsum = floatval($totalAmount);
}else{
    $itemsum = floatval($payment->advance_amount);
}
...
@endphp
<div class="row">
	<div class="col-sm-6"> <label for="date" class="control-label">Rupees in Word  :</label> 
	 {{$billamountInWords}} </div>	
</div>
<br>
	 <br>
<div class="row">
	<div class="col-sm-6"> <label for="date" class="control-label">Amount :</label> 
	{{$itemsum}} </div>	
</div>
