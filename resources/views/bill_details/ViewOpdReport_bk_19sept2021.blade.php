...
var case_amount_total = 0;
	 theGrid = $('#thegrid').DataTable({
        ...
        "drawCallback": function ( settings ) {
			...
			//----------------------------------------------------------------------
			var api = this.api();
			$( api.table().footer() ).html("<th></th><th></th><th></th><th></th><th></th><th><span style='b'>Total</span></th><th> "+
				api.column( 6, {page:'current'} ).data().sum()+"</th><th> "+
				api.column( 7, {page:'current'} ).data().sum()+"</th><th> "+
				api.column( 8, {page:'current'} ).data().sum()+"</th><th> "+
				api.column( 9, {page:'current'} ).data().sum()+"</th><th></th><th> "+
				api.column( 11, {page:'current'} ).data().sum()+"</th>"
			);
        }
    } );
