...
<div class="col-md-2">
	...
	<div class="input-group">
		<select class="select2">
			...
			<option value="procedure_surgery">Procedure/Surgery</option>
			<option value="vision">Vision</option>
			<option value="fix_surgery">Fix Surgery</option>
		</select>		
	</div>
</div>
							</div>
	...
	<div class="col-md-12" id="patients_search">
@include('bill_details.search_elements.patients')
	</div>
