...
<script src="{{ url('/')}}/select2/js/select2.min.js"></script>
   ...
   // alert(docid);
     ...
     theGrid = $('#thegrid').DataTable({
                ...
                //"ajax": "{{url('hms_doctor/public/patientbill/report/grid')}}/",//+docid,
                "order": [[ 0, "desc" ]],
                "columnDefs": [
                    {
                        "targets": 0,
      ...
      var api = this.api();
      $( api.table().footer() ).html("<th></th><th></th><th></th><th></th><th></th><th></th><th><span style='b'>Total "+
        api.column( 6, {page:'current'} ).data().sum()+"</span></th>"
      );
    }
