...
<div class="row clearfix">
        ...
        <a href="{{url('Other_Medicine/create')}}" class="btn btn-primary btn-lg" role="button">Add medicine</a></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            theGrid = $('#thegrid').DataTable({
                ...
                "ordering": true,
                "responsive": false,
                "ajax": "{{url('other_medical_stores/grid')}}",
                "columnDefs": [
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/Other_Medicine') }}/'+row[0]+'" class="btn btn-default">Update</a>';
                        },
                        "targets": 6                    },
                        {
                        "render": function ( data, type, row ) {
        ...
        closeOnConfirm: false
               ...
               $.ajax({ url: '{{ url('/other_medical_stores') }}/' + id, 
                        type: 'POST',
