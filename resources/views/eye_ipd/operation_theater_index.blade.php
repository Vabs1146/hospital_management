                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTable js-exportable" id="thegrid" data-stripe-classes="[]">
                              <thead>
                                <tr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            theGrid = $('#thegrid').DataTable({
                ...
                "responsive": false,
                "autoWidth": false,
                "ajax": { "url" : "{{url('eyeipd_operation_rec/grid')}}", 'type':'POST', data: {_method: 'POST', _token :$("#hdnCsrfToken").data('token')}},
                "order": [[ 0, "desc" ]],
                lengthMenu: [
            [ 10, 25, 50, -1 ],
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/eyeoperation') }}/'+row[0]+'/edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>';
                        },
                        "sortable": false,
                        "targets": 8                    
                    },
