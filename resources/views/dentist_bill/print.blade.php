...
/*
                         ...
                         <td align="right"> 
                            <p></p>
                            <label for="totalAmount" class="control-label">Total Balance</label>  
                        </td>
                        <td> 
                            <?php $itemsum = 0; 
                                    $itemsum = $dentist_bill->sum('balance'); 
...
*/
          ...
          <table class="table table-bordered">
            ...
            <thead>
                <tr>
                    <th>    
                        {{ Form::label('Payment For','Payment For') }} 
                    </th>
                    <th>
                        {{ Form::label('date','Date') }} 
            ...
            @foreach($paymentfor as $billdata) 
                    <tr>
                        <td> {{ $billdata->treatmentDone }} </td>
                        <td> {{ $billdata->date }} </td>
                        <td>{{ $billdata->amountPaid }} </td>
