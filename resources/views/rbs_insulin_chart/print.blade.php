...
<div class="col-md-12" style="background: white;">
	<div class="col-sm-2">
		<div class="form-group labelgrp">            
			{{ Form::label('pre_ivf_hysteroscopy','Name :') }} 
		</div>
	</div>
	<div class="col-md-3">
	...
	<div class="col-md-1"><div class="form-group labelgrp">            
			{{ Form::label('Age','Age :') }} 
		</div>
	</div>
	<div class="col-md-2">
	...
	<div class="col-md-2"><div class="form-group labelgrp">            
...
<div class="col-md-12">
	...
	<div class="col-md-2"><div class="form-group labelgrp">            
			{{ Form::label('HID No','Date :') }} 
		</div>
	</div>
	<div class="col-md-2">
		<div class="form-group">
			<div class="form-line">
				{{isset($rbs_insulin_chart_record->date)? $rbs_insulin_chart_record->date : '-'}}                         
			</div>
		</div>
	</div>
</div>
...
@include('rbs_insulin_chart.elements.rbs_insulin_chart_table_print')
