                  ...
                  <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="panel-footer">
                         <a href="{{url('/dynamicForm/1/0/edit')}}" class="btn btn-primary" role="button">Add New</a>
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/dynamicForm/1/') }}/'+row[0]+'/edit" class="btn btn-default btn-circle waves-effect waves-circle waves-float"><i class="fa fa-edit" aria-hidden="true"></i></a>';
                        },
                        "sortable": false,
                        "targets": 7                    
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/dynamicForm/print/1/') }}/'+row[0] +'"target="_blank" class="btn btn-default btn-circle waves-effect waves-circle waves-float" ><i class="fa fa-print" aria-hidden="true"></i></a>';
                        },
                        "sortable": false,
                        "targets": 8                   
                    },
                    {
                        "render": function ( data, type, row ) {
                            return '<a href="{{ url('/dynamicForm/view/1/') }}/'+row[0] +'" class="btn btn-default btn-circle waves-effect waves-circle waves-float"><i class="fa fa-eye" aria-hidden="true"></i></a>';
                        },
                        "sortable": false,
                        "targets": 9                
                    }
