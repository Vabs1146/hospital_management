             ...
             `                 <div class="form-line">
                            ...
                            <div class="row clearfix" id="AnesthetistNote"> 
                             ...
                             <div class="row clearfix">
                              ...
                              <button type="submit" name="submit" class="btn btn-success" value="submit"><i class="fa fa-plus"></i> Submit
                              </button>
                              <a class="btn btn-default" href="{{ url('/eyeoperation/print').'/'. $case_master->id }}" target="_blank"><i class="glyphicon glyphicon-print"></i> Print </a>
