                                    ...
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="sectiontable" name="sectiontable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align=''><input type="checkbox" id="selectallPrint" data-type="Print" name="isActivePrint" class="filled-in" /><label for="selectallPrint">Print</label></th>
                                            </tr>
                                        </thead>
                                        <tbody>
@php $parent_menu=""; @endphp
                                            ...
                                            <tr><td colspan="8"></td></tr>
                                               <tr><td colspan="3">{{$sectionlist->parent_title}}</td><td colspan="5"></td></tr>
                                            @endif
                                            <tr>
...
<td>
    <div class="demo-checkbox">
        <input type="checkbox" id="selectrecPrint{{$sectionlist->sectionid}}" data-section="{{$sectionlist->sectionid}}" data-col="print_permission" name="selectrecPrint[]" class="chk selectrecPrint" value="{{ $sectionlist->sectionid }}" <?php echo ($sectionlist->print_permission == "1") ? "checked" : "unchecked"; ?> class="filled-in">
        <label for="selectrecPrint{{$sectionlist->sectionid}}"></label>
    </div>
</td>
