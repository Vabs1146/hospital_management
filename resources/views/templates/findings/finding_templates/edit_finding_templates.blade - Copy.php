...
@endif     
<div class="card">
{{ Form::model($casedata, array('url' => url('update-findings-template').'/'.$template_id.'/'.$case_id, 'method' => 'POST','id'=>'eyeform',  'class' => 'form-horizontal', 'enctype' => 'multipart/form-data' )) }}
{{ csrf_field() }}
