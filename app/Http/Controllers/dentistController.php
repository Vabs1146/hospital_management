...
class dentistController extends AdminRootController
{
    ...
    public function edit(Request $request, $id)
    {
       ...
       //dd($dentist);
        ...
        //dd($dentist_pain_in->pluck('pain_in_teeth')->toArray());
        /*
        ...
        */
        ...
        return view('dentist.add', compact('case_master','dentist', 'DateWiseRecordLst','dentist_pain_in', 'commonHelper'));
    }
   ...
   ///////////Dentist-pdf-Mail-///////////////////
    public function update(Request $request){
        ...
        $form_details->dentist_pain_in()->delete();
...
/////////////////////////////////////////
    ...
    public function printbill($id){
        ...
        $logoUrl = $helperCls->GetDentistLetterHeadImageUrl();
        $FooterUrl = $helperCls->GetDentistLetterFooterImageUrl();
                
        return view('dentist.print', compact('case_master','dentist', 'DateWiseRecordLst','dentist_pain_in','logoUrl','dentist_bill', 'FooterUrl'));
    }
