...
class IvfController extends AdminRootController
{
    ...
    public function ivf_icsi(Request $request, $id)
    {
       //echo "============>>>>>> <pre>".__LINE__; print_r([]); exit;
        /*
        $doctorlist = doctor::where('isActive', 1)->orderBy('doctor_name')
       ...
       //echo "============>>>>>> <pre>".__LINE__; print_r($ivf_icsi); exit;
        ...
        return view('ivf.ivf_icsi', ['casedata' => $this->getCaseData($id), 'doctorlist' => $doctorlist, 'ivf_icsi' => $ivf_icsi, 'ivf_icsi_menses' => $ivf_icsi_menses, 'ivf_icsi_ovary' => $ivf_icsi_ovary, 'ivf_icsi_medicine' => $ivf_icsi_medicine, 'ivf_icsi_medicine_details' => $ivf_icsi_medicine_details ]);
        */
        $data = $this->get_icsi_form($request, $id);
        return view('ivf.ivf_icsi', $data);
    }
    
    public function ivf_icsi_view(Request $request, $id) {
        $data = $this->get_icsi_form($request, $id);
    ...
    public function ivf_icsi_print(Request $request, $id) {
        $data = $this->get_icsi_form($request, $id);
        return view('ivf.ivf_icsi_print', $data);
    }
